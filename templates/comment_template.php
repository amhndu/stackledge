        ...
        <div class="info">
            ...
            <a class="upvote" href="javascript:void(0)" onclick="<?php echo $comment_upvote_href?>">
                <div class="iconfont <?php echo $comment_upvoted_class?>"><i class="fa fa-caret-up fa-lg" aria-hidden="true"></i></div>
            </a>
            ...
            <a class="downvote" href="javascript:void(0)" onclick="<?php echo $comment_downvote_href?>">
                <div class="iconfont <?php echo $comment_downvoted_class?>"><i class="fa fa-caret-down fa-lg" aria-hidden="true"></i></div>
            </a>
            </div>
